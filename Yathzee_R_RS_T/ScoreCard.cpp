...
void ScoreCard::card(list<ScoreCard>::iterator i, set<Player>::iterator j)
{
    ...
    cout << "|------------------------------------------------------------------" << endl;
    cout << "| 1 - Aces:    " << setw(2) << i->getOne() << "\t | \t" << "7. 3 of a Kind : " << setw(2) << 1 << "\t \t  |" << endl;
    cout << "| -----------------------------------------------------------------" << endl;
    cout << "| 2 - Twos:    " << setw(2) << i->getTwo() << "\t | \t""8. 4 of a Kind: " << setw(2) << 1 << "\t \t  |" << endl;
    cout << "|------------------------------------------------------------------" << endl;
    cout << "| 3 - Threes:  " << setw(2) << i->getThree() << "\t | \t""9. Full House : " << setw(2) << 1 << "\t \t  |" << endl;
    cout << "|------------------------------------------------------------------" << endl;
    cout << "| 4 - Fours:   " << setw(2) << i->getFour()<< "\t | \t" "10. Small Straight : "<< setw(2) << 1 << "\t \t  |" << endl;
    cout << "|------------------------------------------------------------------" << endl;
    cout << "| 5 - Fives:   " << setw(2) << i->getFive()  << "\t | \t""11. Large Straight : " << setw(2) << 1 << "\t \t  |" << endl;
    cout << "|------------------------------------------------------------------" << endl;
    cout << "| 6 - Sixes:   " << setw(2) << i->getSix()<< "\t | \t"<< "12. Yahtzee: " << setw(2) << 1 << "\t \t \t  |" << endl;
    cout << "|------------------------------------------------------------------" << endl;
